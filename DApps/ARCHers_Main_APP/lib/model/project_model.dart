...
List<Project> projectList = [
  Project(
    'Archers view',
    'Presenting Our decentralized platform enables secure NFT , DeFi participation, and digital asset management. Join us in shaping decentralized asset management!"',
    'assets/images/image.png',
    'https://github.com',
  ),
  Project(
    'Archers Assembles',
    'Avenger theme 3D open world game ',
    'assets/images/car.jpg',
    'https://mysticog.itch.io/archers-assemble',
  ),
//   Project(
//       'Neumorphic Clockify',
